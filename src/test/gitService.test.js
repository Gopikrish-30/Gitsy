...
suite('GitService Test Suite', () => {
    ...
    test('GitService initializes with workspace', () => {
        ...
        if (workspaceFolders && workspaceFolders.length > 0) {
            const gitService = new gitService_1.GitService(workspaceFolders[0].uri.fsPath);
    ...
    test('Branch name escaping works correctly', () => {
        const gitService = new gitService_1.GitService('/tmp');
        // Access private method through any cast for testing
        const escapeBranchName = gitService.escapeBranchName;
